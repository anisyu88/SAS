...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'PDF_CREATOR');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'SISWI ACCOMMMODATION SYSTEM');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Approve Applications');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by Siswi Accomodation System - SAS");
}
