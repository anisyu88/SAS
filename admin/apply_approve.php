                ...
                <div class="col-12 col-xl-12 m-b-10">
                  <div class="card">
                    <div class="card-header border-bottom">
                      <h4 class="card-title">List of Approve Student Application</h4>
                    </div>
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                        <table id="myTable" class="table table-hover mb-0">
                          ...
                          $query = "SELECT * FROM apply WHERE status = 'Approved'"; 
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                              ...
                              ?>
                                                ...
                                                <td><?php echo $counter++; ?></p></td> <!-- Row number -->
                                                    ...
                                                    <td><p class="text-sm text-center font-weight-bold mb-0"><?php echo $row['status']; ?></p></td>
                        ...
                        <div class="text-center">
                          <a href="generate_print/approve_print.php" class="btn btn-outline-info" target="_blank">Print PDF</a> <!-- Print button -->
                        </div>
                      </div>
                    </div>
                  </div>
