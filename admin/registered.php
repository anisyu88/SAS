                ...
                <div class="col-12 col-xl-12 m-b-10">
                  <div class="card">
                    <div class="card-header border-bottom">
                      <h4 class="card-title">List Registered Student </h4>
                    </div>
                    <div class="card-body">
                      ...
                      $query = "
                          SELECT student.studid, student.studname, student.sem, student.status, registration.register_date 
                          FROM student 
                          INNER JOIN registration 
                          ON student.studid = registration.studid
                          WHERE student.status = 'registered'"; 
                      ...
                      if (mysqli_num_rows($result) > 0) {
                          ...
                          while ($row = mysqli_fetch_array($result)) { ?>
                              <ol> 
                                  <tr>
                                      ...
                                      <td><p class="text-sm font-weight-bold mb-0"><?php echo htmlspecialchars($row['register_date']); ?></p></td> <!-- Registration Date -->
                          ...
                          echo "<tbody><tr><td colspan='6'>There is no registered student.</td></tr></tbody>";
                      }
                      ?>
                        ...
                        <div class="text-right">
                          <a href="generate_print/registered_print.php" class="btn btn-dark text-light" target="_blank">Print PDF</a> <!-- Print button -->
                        </div>
                      </div>
                    </div>
                  </div>
