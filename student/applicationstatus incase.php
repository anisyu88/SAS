...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['booking'])) {
    ...
    if ($resultRoom->num_rows > 0) {
        ...
        // Check if room is under maintenance or already booked
        if ($status == 'maintenance' || $status == 'booked') {
            ...
            if ($stmtBooking->execute()) {
                ...
                if ($resultName->num_rows > 0) {
                    ...
                    // Show SweetAlert for successful booking with options to download PDF or go to profile
                    echo "<script>
                        document.addEventListener('DOMContentLoaded', function() {
                            Swal.fire({
                                title: 'Booking Successful!',
                                text: 'Your room has been booked successfully. PDF has been generated.',
                                icon: 'success',
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    window.location.href = 'booking_invoice/{$studid}_booking.pdf';
                                } else {
